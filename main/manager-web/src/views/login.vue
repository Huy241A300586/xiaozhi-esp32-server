      ...
      <el-main class="auth-main">
        <div class="login-box" @keyup.enter="login">
          ...
          <div class="title-stack">
            ...
            <div class="login-text">Chào mừng trở lại</div>
            <div class="login-welcome">Đăng nhập vào DeskBot Console để quản lý thiết bị, theo dõi tác vụ và vận hành các luồng AI trong một không gian gọn, sáng và tập trung.</div>
          </div>
