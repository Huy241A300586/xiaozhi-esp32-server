export default {
  ...
  'contextProviderDialog.requestHeaders': 'Header request',
  'contextProviderDialog.headerKeyPlaceholder': 'Khóa',
  'contextProviderDialog.headerValuePlaceholder': 'Giá trị',
  'contextProviderDialog.noHeaders': 'Không có header nào',
  ...
  'modelConfig.setDefaultSuccess': 'Đặt mô hình mặc định thành công, vui lòng khởi động lại xiaozhi-server thủ công sớm nhất có thể',
  ...
  'ttsModel.enterRemark': 'Vui lòng nhập ghi chú',
  'ttsModel.referenceAudioPath': 'Đường dẫn âm thanh tham chiếu',
  'ttsModel.enterReferenceAudio': 'Vui lòng nhập đường dẫn âm thanh tham chiếu',
  'ttsModel.referenceText': 'Văn bản âm thanh tham chiếu',
  'ttsModel.enterReferenceText': 'Vui lòng nhập văn bản tham chiếu cho âm thanh',
  'ttsModel.action': 'Thao tác',
  ...
  'providerManagement.modelType.TTS': 'Tổng hợp giọng nói',
  ...
  'providerManagement.modelType.Memory': 'Bộ nhớ hội thoại',
  ...
  'providerDialog.fieldType': 'Kiểu trường',
  'providerDialog.type': 'Loại',
  'providerDialog.stringType': 'Chuỗi',
  'providerDialog.numberType': 'Số',
  'providerDialog.booleanType': 'Đúng/Sai',
  'providerDialog.dictType': 'Từ điển',
  'providerDialog.arrayType': 'Danh sách (phân tách bằng dấu chấm phẩy)',
  'providerDialog.ragType': 'RAG',
  'providerDialog.defaultValue': 'Giá trị mặc định',
  'providerDialog.inputDefaultValue': 'Vui lòng nhập giá trị mặc định của trường',
  ...
  'voiceClone.trainStatus': 'Trạng thái huấn luyện',
  ...
  'voiceClone.addVoiceClone': 'Thêm giọng nói nhân bản',
  ...
  'voiceClone.noVoiceCloneAssigned': 'Tài khoản của bạn chưa được gán tài nguyên giọng nói',
  ...
  'voiceClone.stepUpload': 'Tải lên âm thanh',
  'voiceClone.stepEdit': 'Chỉnh sửa bản ghi âm',
  ...
  'knowledgeFileUpload.parse': 'Phân tích tài liệu',
  'knowledgeFileUpload.viewSlices': 'Xem phân đoạn',
  ...
  'knowledgeFileUpload.parseSuccess': 'Phân tích tài liệu thành công',
  'knowledgeFileUpload.parseFailed': 'Phân tích tài liệu thất bại',
  ...
  'knowledgeFileUpload.confirmParse': 'Bạn có chắc chắn muốn phân tích tài liệu này?',
  ...
  'knowledgeFileUpload.parseCancelled': 'Đã hủy phân tích tài liệu',
  ...
  'knowledgeFileUpload.sliceCount': 'Số phân đoạn',
  'knowledgeFileUpload.add': 'Thêm',
  'knowledgeFileUpload.retrievalTest': 'Kiểm tra truy hồi',
  ...
  'knowledgeFileUpload.slice': 'Phân đoạn',
  'knowledgeFileUpload.noSliceData': 'Không có dữ liệu phân đoạn',
  ...
  'knowledgeFileUpload.testQuestion': 'Câu hỏi kiểm tra',
  'knowledgeFileUpload.testQuestionPlaceholder': 'Vui lòng nhập câu hỏi để kiểm tra',
  'knowledgeFileUpload.runTest': 'Chạy truy hồi thử',
  'knowledgeFileUpload.testResult': 'Kết quả kiểm tra:',
  'knowledgeFileUpload.noRelatedSlices': 'Không tìm thấy phân đoạn liên quan',
  'knowledgeFileUpload.comprehensiveSimilarity': 'Độ tương đồng tổng hợp',
